...
var Regs = {
  ...
  // 正浮点数：
  posiFloat: /^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/,
  ...
  // 座机号码:
  telephone: /(^(\d{2,4}[-_－—]?)?\d{3,8}([-_－—]?\d{3,8})?([-_－—]?\d{1,7})?$)|(^0?1[35]\d{9}$)/,

  // 座机或手机号:
  teleMobile: /(\d{3}[-_－—]\d{8}|\d{4}[-_－—]\d{7,8})?$|(^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,1,3,5-8])|(18[0-9])|(147))\d{8}$)/,
